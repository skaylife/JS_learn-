window.addEventListener('DOMContentLoaded', function () {
  ...
  function getStaticInformation(parentSelector, activeClass) {
    const elements = document.querySelectorAll(`${parentSelector} div`); // Получаем все div-ы
  ...
  //   slides[slideIndex - 1].style.display = 'block'; // Если стоит 1, то это ноль для кода 
  ...
  //   showSlides(slideIndex += n); // Вызов функции 
  // }
